function plot_variables_xz(filename)
...
for i=1:4
    ...
    subplot(2,2,i)
    if(i==2)
        contourf(xt(lb:ub),zt,(squeeze(matVar(i,:,lb:ub,dimlen1/2))),10)

    else
        contourf(xt(lb:ub),zt,(squeeze(matVar(i,:,lb:ub,dimlen1/2))),-bound_vec(i):h_vec(i):bound_vec(i))
    end
